...
std::shared_ptr<spdlog::logger> Hazel::Console::s_CoreLogger;
std::shared_ptr<spdlog::logger> Hazel::Console::s_ClientLogger;

void Hazel::Console::Init()
{
